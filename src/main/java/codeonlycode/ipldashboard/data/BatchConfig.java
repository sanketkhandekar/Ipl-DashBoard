...
public class BatchConfig {
    ...
    private final String[] FILED_NAMES = {
    ...
    public JdbcBatchItemWriter<Match> writer(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<Match>()
                ...
                .sql("INSERT INTO match (id,city,date,player_of_match,venue,team1,team2,toss_winner," +
                        "toss_decision,match_winner,result,result_margin,method,umpire1,umpire2) " +
                        "VALUES (:id,:city,:date,:playerOfMatch,:venue,:team1,:team2," +
                        ":tossWinner,:tossDecision,:matchWinner,:result,:resultMargin,:method,:umpire1,:umpire2)")
